...
"}")
        ...
        self.frame_top_info.setEnabled(False)
        ...
        self.label_top_info_1.setEnabled(False)
...
"}")
        ...
        self.user_input.setDragEnabled(False)
        self.search_btn = QPushButton(self.page_home)
        self.search_btn.setObjectName(u"search_btn")
        self.search_btn.setGeometry(QRect(370, 190, 81, 81))
        self.search_btn.setStyleSheet(u"QPushButton {\n"
"	background-image: url(:/24x24/icons/24x24/icon_search.png);\n"
"	background-position: center;\n"
"	background-repeat: no-reperat;\n"
"	border: none;\n"
"	background-color: rgb(27, 29, 35);\n"
...
"	background-color: rgb(85, 170, 255);\n"
"}")
        self.sound_btn = QPushButton(self.page_home)
...
"	background-color: rgb(85, 170, 255);\n"
"}")
        self.answer_output = QTextEdit(self.page_home)
        self.answer_output.setObjectName(u"answer_output")
        self.answer_output.setGeometry(QRect(70, 300, 751, 251))
        font7 = QFont()
        font7.setFamily(u"Segoe UI Light")
        font7.setPointSize(16)
        self.answer_output.setFont(font7)
        self.answer_output.viewport().setProperty("cursor", QCursor(Qt.IBeamCursor))
        self.answer_output.setStyleSheet(u"QTextEdit {\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	border: 2px solid rgb(27, 29, 35);\n"
"	padding-left: 10px;\n"
...
"}")
        ...
        self.youtube_search_input = QLineEdit(self.page_youtube)
        self.youtube_search_input.setObjectName(u"youtube_search_input")
        self.youtube_search_input.setGeometry(QRect(80, 147, 691, 41))
        font8 = QFont()
        font8.setPointSize(12)
        self.youtube_search_input.setFont(font8)
        self.youtube_search_input.setStyleSheet(u"QLineEdit {\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	border: 2px solid rgb(27, 29, 35);\n"
"	padding-left: 10px;\n"
...
"	border: 2px solid rgb(91, 101, 124);\n"
"}")
        self.youtube_label = QLabel(self.page_youtube)
        self.youtube_label.setObjectName(u"youtube_label")
        self.youtube_label.setGeometry(QRect(60, 10, 451, 101))
        font9 = QFont()
        ...
        font9.setWeight(50)
        self.youtube_label.setFont(font9)
        self.youtube_label.setStyleSheet(u"font: 28pt \"MS Shell Dlg 2\";")
        self.youtube_search_btn = QPushButton(self.page_youtube)
        self.youtube_search_btn.setObjectName(u"youtube_search_btn")
        self.youtube_search_btn.setGeometry(QRect(770, 147, 51, 41))
        sizePolicy.setHeightForWidth(self.youtube_search_btn.sizePolicy().hasHeightForWidth())
        self.youtube_search_btn.setSizePolicy(sizePolicy)
        self.youtube_search_btn.setStyleSheet(u"QPushButton {\n"
...
"	background-color: rgb(85, 170, 255);\n"
"}")
        self.youtube_pause = QPushButton(self.page_youtube)
        self.youtube_pause.setObjectName(u"youtube_pause")
        self.youtube_pause.setGeometry(QRect(380, 233, 71, 61))
        sizePolicy.setHeightForWidth(self.youtube_pause.sizePolicy().hasHeightForWidth())
        self.youtube_pause.setSizePolicy(sizePolicy)
        self.youtube_pause.setStyleSheet(u"QPushButton {\n"
...
"	background-color: rgb(85, 170, 255);\n"
"}")
        self.youtube_stop = QPushButton(self.page_youtube)
        self.youtube_stop.setObjectName(u"youtube_stop")
        self.youtube_stop.setGeometry(QRect(450, 233, 71, 61))
        sizePolicy.setHeightForWidth(self.youtube_stop.sizePolicy().hasHeightForWidth())
        self.youtube_stop.setSizePolicy(sizePolicy)
        self.youtube_stop.setStyleSheet(u"QPushButton {\n"
"	background-image: url(:/20x20/icons/20x20/cil-media-stop.png);\n"
"	background-position: center;\n"
"	background-repeat: no-reperat;\n"
"	border: none;\n"
"	background-color: rgb(27, 29, 35);\n"
...
"}")
        ...
        self.src_text.setObjectName(u"src_text")
        self.src_text.setGeometry(QRect(50, 230, 371, 261))
        self.src_text.setFont(font7)
        self.src_text.viewport().setProperty("cursor", QCursor(Qt.IBeamCursor))
        self.src_text.setStyleSheet(u"QTextEdit {\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	border: 2px solid rgb(27, 29, 35);\n"
"	padding-left: 10px;\n"
...
"	border: 2px solid rgb(91, 101, 124);\n"
"}")
        self.dest_text = QTextEdit(self.page_translate)
        self.dest_text.setObjectName(u"dest_text")
        self.dest_text.setGeometry(QRect(481, 230, 371, 261))
        self.dest_text.setFont(font7)
        self.dest_text.viewport().setProperty("cursor", QCursor(Qt.IBeamCursor))
        self.dest_text.setStyleSheet(u"QTextEdit {\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	border: 2px solid rgb(27, 29, 35);\n"
"	padding-left: 10px;\n"
...
"	border: 2px solid rgb(91, 101, 124);\n"
"}")
        self.translate_btn = QPushButton(self.page_translate)
...
"	selection-background-color: rgb(39, 44, 54);\n"
"}")
        self.src_sound = QPushButton(self.page_translate)
        self.src_sound.setObjectName(u"src_sound")
        self.src_sound.setGeometry(QRect(370, 490, 51, 51))
        sizePolicy.setHeightForWidth(self.src_sound.sizePolicy().hasHeightForWidth())
        self.src_sound.setSizePolicy(sizePolicy)
        self.src_sound.setStyleSheet(u"QPushButton {\n"
"	background-image: url(:/16x16/icons/16x16/cil-volume-high.png);\n"
"	background-position: center;\n"
"	background-repeat: no-reperat;\n"
"	border: none;\n"
"	background-color: rgb(27, 29, 35);\n"
...
"	background-color: rgb(85, 170, 255);\n"
"}")
        self.dest_sound = QPushButton(self.page_translate)
        self.dest_sound.setObjectName(u"dest_sound")
        self.dest_sound.setGeometry(QRect(800, 490, 51, 51))
        sizePolicy.setHeightForWidth(self.dest_sound.sizePolicy().hasHeightForWidth())
        self.dest_sound.setSizePolicy(sizePolicy)
        self.dest_sound.setStyleSheet(u"QPushButton {\n"
"	background-image: url(:/16x16/icons/16x16/cil-volume-high.png);\n"
"	background-position: center;\n"
"	background-repeat: no-reperat;\n"
"	border: none;\n"
...
#endif // QT_CONFIG(tooltip)
        self.youtube_search_btn.setText("")
#if QT_CONFIG(tooltip)
        self.youtube_pause.setToolTip(QCoreApplication.translate("MainWindow", u"Pause/Resume", None))
#endif // QT_CONFIG(tooltip)
        self.youtube_pause.setText("")
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.src_sound.setText("")
#if QT_CONFIG(tooltip)
        self.dest_sound.setToolTip(QCoreApplication.translate("MainWindow", u"Speaker", None))
#endif // QT_CONFIG(tooltip)
        self.dest_sound.setText("")
